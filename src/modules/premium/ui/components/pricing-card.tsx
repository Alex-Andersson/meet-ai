...
const pricingCardSecondaryTextVariants = cva("text-natural-700", {
    variants: {
        variant: {
            default: "text-natural-700",
            highlighted: "text-natural-300",
        },
    },
});
...
interface Prop extends VariantProps<typeof pricingCardVariants> {
    badge?: string | null;
    price: number;
    features: string[];
    title: string;
    ...
    return(
        <div className={cn(pricingCardVariants({ variant }), className, "border")}>
            ...
            <div className="flex flex-col gap-y-2 mt-6">
                ...
                <ul className={cn("flex flex-col gap-y-2", pricingCardSecondaryTextVariants({ variant }))}>
